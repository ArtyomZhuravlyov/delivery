...
public class Client : IGeoClient
{
    ...
    public async Task<Result<DeliveryApp.Core.Domain.Model.SharedKernel.Location, Error>> GetGeolocationAsync(string street,
        CancellationToken cancellationToken)
    {
        ...
        var locationCreateResult = DeliveryApp.Core.Domain.Model.SharedKernel.Location.Create(reply.Location.X, reply.Location.Y);
